...
import { Headphones, Lock, ArrowRight } from 'lucide-react'
...
export default function SupportPage() {
  ...
  const content = {
    fr: {
      badge: 'Support',
      title: 'Support Hackboot',
      subtitle: 'Accès réservé aux utilisateurs connectés',
      description: 'Pour accéder à notre support technique et soumettre des tickets, vous devez être connecté avec un compte Hackboot.',
    ...
    en: {
      badge: 'Support',
      title: 'Hackboot Support',
      subtitle: 'Access reserved for logged-in users',
      description: 'To access our technical support and submit tickets, you need to be logged in with a Hackboot account.',
      loginButton: 'Log in',
    ...
    et: {
      ...
      description: 'Meie tehnilise toe ja piletite esitamiseks peate olema Hackbooti kontoga sisse logitud.',
