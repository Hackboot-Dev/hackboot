...
export default function APIPage() {
  ...
  const content = {
    fr: {
      ...
      description: 'Pour accéder à notre API et obtenir vos clés d\'accès, vous devez être connecté avec un compte Hackboot.',
    ...
    en: {
      ...
      description: 'To access our API and get your access keys, you need to be logged in with a Hackboot account.',
      loginButton: 'Log in',
    ...
    et: {
      ...
      description: 'Meie API-le juurdepääsuks ja juurdepääsuvõtmete saamiseks peate olema Hackbooti kontoga sisse logitud.',
