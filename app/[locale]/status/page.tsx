...
export default function StatusPage() {
  ...
  const content = {
    fr: {
      ...
      description: 'Pour consulter le statut de nos services en temps réel, vous devez être connecté avec un compte Hackboot.',
    ...
    en: {
      ...
      description: 'To view the real-time status of our services, you need to be logged in with a Hackboot account.',
      loginButton: 'Log in',
    ...
    et: {
      ...
      description: 'Meie teenuste reaalajas oleku vaatamiseks peate olema Hackbooti kontoga sisse logitud.',
